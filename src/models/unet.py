...
class Unet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.upconv5 = nn.ConvTranspose2d(512, 512, kernel_size=3, padding=(0, 1), stride=2, output_padding=(0, 1))
        ...
        self.upconv4 = nn.ConvTranspose2d(512, 512, kernel_size=3, padding=(0, 1), stride=2, output_padding=(0, 1))
...
def unet(in_channels, out_channels, pretrained=False):
